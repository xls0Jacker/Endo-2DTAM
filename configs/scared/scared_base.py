...
scenes = [
    "dataset_1/keyframe_3", 
    "dataset_2/keyframe_4", 
    "dataset_3/keyframe_4", 
    "dataset_4/keyframe_4", 
    "dataset_5/keyframe_4", 
    "dataset_6/keyframe_4", 
    "dataset_7/keyframe_4", 
...
tracking_iters = 15
mapping_iters = 25
init_mapping_iters = 1000

group_name = "SCARED_base"
run_name = scene_name
...
config = dict(
    ...
    data=dict(
        ...
        sequence=scene_name,
        desired_image_height=1024//2,
        desired_image_width=1280//2,
        start=0,
        end=-1,
        stride=1,
        num_frames=-1,
    ...
    mapping=dict(
        ...
        num_init_iters=init_mapping_iters,
